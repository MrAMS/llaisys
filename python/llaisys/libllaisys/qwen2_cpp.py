...
def load_qwen2_cpp(lib):
    ...
    lib.llaisysQwen2SchedulerAdd.argtypes = [ctypes.POINTER(LlaisysQwen2Model), ctypes.c_uint64, ctypes.POINTER(ctypes.c_int64), ctypes.c_size_t, ctypes.c_uint64, ctypes.c_float]
