...
namespace PagedCache {
    ...
    public:
        ...
        Sequence(uint64_t seq_id, const std::vector<token_t>& seq_tokens, BlockManager* manager, token_t eos_token);
    ...
    public:
        ...
        void add(uint64_t seq_id, const std::vector<token_t>& seq_tokens, token_t eos_token);
